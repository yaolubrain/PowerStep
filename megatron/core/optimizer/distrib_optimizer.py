        ...
        for group_range in opt_group_ranges:
            ...
            for model_param in group_range["params"]:
                ...
                if model_param.type() in ['torch.cuda.HalfTensor', 'torch.cuda.BFloat16Tensor']:
                    ...
                    # shard_main_param = shard_model_param.clone().bfloat16()
                    # shard_main_param = shard_model_param.clone().half()
        ...
        def copy_group_grads(model_groups, shard_main_groups):
            for model_group, shard_main_group in zip(model_groups, shard_main_groups):
                for model_param, shard_main_param in zip(model_group, shard_main_group):
                    ...
                    # print(f"shard_model_grad dtype {shard_model_grad.dtype}")
                    # shard_main_param.grad = shard_model_grad.bfloat16()                    
                    # shard_main_param.grad = shard_model_grad.half()
